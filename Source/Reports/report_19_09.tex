...
f(t) = -\frac{a}{bt + c} + d
\end{equation}
which $a = 4.741$, $b = 2.415$, $c = 67.565$, $d = 0.277$ and $t$ is the number of days since the first observation (t = 0). For these fits, the Mean Squared Errors obtained for Soybeans 231 and 232 were respectively $8.436 \times 10^{-4}$ and $8.220 \times 10^{-4}$.
