...
\begin{frame}{Introdução}
    ...
    \begin{figure}%
        \centering
        \subfloat[\textit{Single Look}]{{\includegraphics[width = .45\linewidth]{oberpfaffenhofen_trad_algorithm_reduced.png} }}%
        \qquad
        \subfloat[\textit{Multilook}]{{\includegraphics[width=.45\linewidth]{traunstein_trad_algorithm_reduced.png} }}%
...
\begin{frame}{Regiões analisadas}
      \begin{figure}%
        \centering
        \subfloat[Região composta por vegetação]{{\includegraphics[width = .4\linewidth]{forest.png} }}%
        \qquad
        \subfloat[Região composta por solo exposto]{{\includegraphics[width=.4\linewidth]{bare_soil.png} }}%
