...
tri_alpha <- data.frame(
  ...
  SB231 = c(3.109, 4.578, 3.779, 4.672, 4.864), #SOYBEANS 231
  SB232 = c(3.039, 4.124, 4.553, 4.217, 4.02), #SOYBEANS 232
...
rv_alpha <- data.frame(
  ...
  SB231 = c(8.5, 8.073, 6.395, 5.852, 5.478), #SOYBEANS 231
  SB232 = c(9.334, 8.654, 5.902, 5.891, 6.582), #SOYBEANS 232
...
rv_beta <- data.frame(
  ...
  SB231 = c(16.539, 16.409, 11.777, 10.999, 9.215), #SOYBEANS 231
  SB232 = c(18.516, 17.722, 10.969, 10.621, 11.241), #SOYBEANS 232
...
sb_rv_beta <- data.frame(
  X = 1:5,
  SB101 = c(10.993, 15.978, 11.792, 10.794, 9.438), #SOYBEANS 101
  SB231 = c(16.539, 16.477, 11.777, 10.999, 9.215), #SOYBEANS 231
