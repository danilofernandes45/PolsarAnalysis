...
tri_alpha <- data.frame(
  ...
  WT104 = c(2.824, 4.287, ), #WHEAT 104
  WT105 = c(2.668, 4.456), #WHEAT 105
...
tri_beta <- data.frame(
  ...
  WT104 = c(10.717, 12.054, ), #WHEAT 104
  WT105 = c(10.152, 13.458, ), #WHEAT 105
...
rv_alpha <- data.frame(
  ...
  WT104 = c(6.145, 6.140, ), #WHEAT 104
  WT105 = c(4.708, 5.582, ), #WHEAT 105
...
rv_beta <- data.frame(
  ...
  WT104 = c(10.938, 10.973, ), #WHEAT 104
  WT105 = c(9.005, 9.885), #WHEAT 105
...
library(ggplot2)
#Analysis per sample
ggplot(aes(x = X, y = value, group = variable, color = variable), data = melt(sb_tri_mean, id.vars = "X")) +
